...
const headCount = async () => {
  // Your code here
  const numberOfStudents = await Student.aggregate().count("studentsCount");
...
const studentId = '64cc49428855365960f9c109';
const result = grade(studentId);
console.log(result);
